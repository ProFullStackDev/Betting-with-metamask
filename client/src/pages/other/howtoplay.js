          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="about-content">
                ...
                <p>
                  Every round a new product image will appear and you and
                  another user have to guess the price of that product. Whoever
                  is closet to the cost of the product wins that round earning
                  the money. But be quick on your toes, because each round only
                  lasts 10 seconds!
                </p>
              </div>
